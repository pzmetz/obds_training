    ...
    for gRNA_sequence_Humagne_C in open("Humagne_C.csv"):
        ...
        for line in data:
            ...
            if gRNA_sequence_Humagne_C in line:
                with open("/dunnstore/hassan/paul/HumagneC.D_validation/Fastq_files/No_list_reads_Humagne_C.fastq","a") as C:
    ...
    for gRNA_sequence_Humagne_D in open("Humagne_D.csv"):
        ...
        for line in data:
            ...
            if gRNA_sequence_Humagne_D in line:
                with open("/dunnstore/hassan/paul/HumagneC.D_validation/Fastq_files/No_list_reads_Humagne_D.fastq","a") as D:
