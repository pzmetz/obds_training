...
#FUNCTION OF THIS SCRIPT:
    ...
    # puts it in a file with reads called pysam_reads_Humagne_C.fastq and if it contains a gRNA from D it puts it in a file with reads called pysam_reads_Humagne_D.fastq
...
fastq_file_path = "/dunnstore/hassan/paul/HumagneC.D_validation/Fastq_files/test_fastq_files/10000_reads.fastq"

# function named 'Determine_C_or_D_gRNAs' of variable defined above
def Determine_C_or_D_gRNAs(fastq_file_path):
    with open("/dunnstore/hassan/paul/HumagneC.D_validation/Fastq_files/pysam_reads_Humagne_C.fastq","a") as C:
        with open("/dunnstore/hassan/paul/HumagneC.D_validation/Fastq_files/pysam_reads_Humagne_D.fastq","a") as D:
            with pysam.FastxFile(fastq_file_path) as fastq_inputfile:
                ...
                for entry in fastq_inputfile:
                    ...
                    for gRNA_sequence_Humagne_D in open("Humagne_D.csv"):
                        if entry.sequence[18:43] in gRNA_sequence_Humagne_D:
                            D.write(str(entry))
                            D.write("\n")
